...
if __name__ == "__main__":
    ...
    # milvusWriter.drop_collection("tech_embeddings")
    # milvusWriter.create_collection("tech_embeddings")
    pipeline = EmbeddingPipeline()
    batch_size = 10
    last_id = 0

    while True:
        embedded_docs, last_id = pipeline.run_batch(batch_size, last_id, collection_name="tech_embeddings")
